class Config:
    ...
    NO_COMMENT_RETRIES = 2         # попыток перегенерации с prefill 'Assistant:' при вызове инструмента без пояснения; после этого — системная инструкция
